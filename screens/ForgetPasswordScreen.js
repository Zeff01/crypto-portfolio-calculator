  ...
  return (
    <>
      ...
      >
        <Logo size={160} />
        <Text
          style={{ fontWeight: "600", fontSize: 18, color: theme.colors.text }}
        >
          Reset Password
        </Text>
        <View className="w-full bg-gray-200 rounded-lg px-6 py-4">
          <View
            className="flex-row gap-2 justify-center items-center border-b px-2 py-3"
          ...
          >
            <FontAwesome
              ...
              size={25}
              color={
                emailValid ? "green" : isEmailFocused ? "#6366f1" : "#242222"
              }
              type="regular"
            />
            <TextInput
