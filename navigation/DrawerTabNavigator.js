...
const CustomHeaderRight = ({ navigation }) => {
    ...
    return (
        <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 20 }} className='flex flex-row items-center mr-[20px]'>
            {/* <View className='bg-[#F2F2F2] rounded-full p-4'>
                <Icon name='eye' size={10.47} onPress={() => handleClick}/>
                
            </View> */}
            <TouchableOpacity className={`rounded-full p-4`}  style={{ backgroundColor: colors.secondary }}onPress={() => toggleTheme()}>
